...
* Specifika innehållspaket som skapas av bygget kan deklareras som överhoppade och kommer inte att distribueras. Mer information finns i [Hoppa över innehållspaket](/help/using/setting-up-project.md#skipping-content-packages) .
