...
[!UICONTROL Cloud Manager] 2018.8.0-versionen innehåller stöd för att automatiskt aktivera CI/CD-flödet när Git implementeras och en ny guide för att skapa programprojekt i Git baserat på AEM Project Archetype.
...
* **Programinstallation** - Ny guide för att skapa ett programprojekt i Git med AEM Project Archetype
...
* Om en ny instans läggs till efter att CI/CD-pipeline har startats körs inte distributionen på den nyligen skapade instansen.
