...
* För att vara konsekvent med Cloud Service hänvisas nu befintliga distributionsledningar till och kallas i användargränssnittet för&quot;fullständig stackning&quot;.
...
* När data som läses från interna system matas in korrekt kan det leda till att orelaterade data från Adobe CSE (Customer Success Engineer) inte återspeglas korrekt i Cloud Manager.
