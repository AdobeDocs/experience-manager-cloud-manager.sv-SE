...
* Git-inloggningsuppgifter kan nu hämtas inifrån användargränssnittet i Cloud Manager. Se [Åtkomst till Git](/help/managing-code/managing-repositories.md) för mer information.
