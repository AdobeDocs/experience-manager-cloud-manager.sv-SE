...
description: Läs om Cloud Manager 2026.1.0 för Adobe Managed Services.
...
# Versionsinformation om Cloud Manager 2026.1.0 i Adobe Managed Services {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Läs mer om [!UICONTROL Cloud Manager] 2026.1.0 för Adobe Managed Services.
...
Lanseringsdatumet för [!UICONTROL Cloud Manager] 2026.1.0 är torsdagen den 22 januari 2026.
...
Det finns inga viktiga felkorrigeringar i Cloud Manager från januari 2026 för AMS.
